...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/sweet-hat-8d5a#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-hat-8d5a
```

A live public deployment of this template is available at [https://sweet-hat-8d5a.templates.workers.dev](https://sweet-hat-8d5a.templates.workers.dev)
